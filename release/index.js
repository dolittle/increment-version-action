...
const VersionIncrementor_1 = __nccwpck_require__(3934);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const previousVersion = (0, core_1.getInput)('version', { required: true });
            const releaseType = (0, core_1.getInput)('release-type', { required: true });
            const prereleaseId = (0, core_1.getInput)('prerelease-id');
...
function output(previousVersion, nextVersion) {
    ...
    (0, core_1.setOutput)('next-version', nextVersion);
}
function fail(error) {
...
const core = __importStar(__nccwpck_require__(6246));
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(4328);
const os = __importStar(__nccwpck_require__(2037));
const path = __importStar(__nccwpck_require__(1017));
/**
 * The code to exit an action
